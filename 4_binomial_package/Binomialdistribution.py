...
class Binomial(Distribution):
    ...
    def calculate_stdev(self):
        ...
        self.stdev = math.sqrt(self.n * self.p * (1 - p))
        return self.stdev
    ...
    def replace_stats_with_data(self):
        ...
        pos = [event for event in self.data if event == 1]
        self.p = len(pos) / self.n
        self.mean = self.calculate_mean()
        self.stdev = self.calculate_stdev()
    ...
    def pdf(self, k):
        ...
        part1 = math.factorial(self.n) / (math.factorial(k) * math.factorial((self.n - k)))
        part2 = math.pow(self.p, k)
        part3 = math.pow((1 - self.p), (self.n - k))
    ...
    def __add__(self, other):
        ...
        new_binominal = Binomial(self.p, self.n + other.n)
        return new_binominal
