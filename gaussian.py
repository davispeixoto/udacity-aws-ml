...
class Gaussian:
    ...
    def calculate_stdev(self, sample=True):
        ...
        self.stdev = math.sqrt((total / divisor))
        return self.stdev
    ...
    def pdf(self, x):
        ...
        part1 = 1 / math.sqrt(2 * math.pi * variance)
        part2a = math.pow((x - self.mean), 2)
        part2b = part2a / (2 * variance)
        part2 = math.exp(-part2b)
        return part1 * part2
